...
func (k Keeper) slashUnbondingDelegation(ctx sdk.Context, unbondingDelegation types.UnbondingDelegation,
	infractionHeight int64, slashFactor sdk.Dec) (totalSlashAmount sdk.Int, tags sdk.Tags) {
	...
	for i, entry := range unbondingDelegation.Entries {
		...
		pool := k.GetPool(ctx)
		tags = tags.AppendTag(fmt.Sprintf(SlashUnbondindDelegation, unbondingDelegation.DelegatorAddress, unbondingDelegation.ValidatorAddress), unbondingSlashAmount.String())
