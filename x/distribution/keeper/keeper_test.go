...
func TestWithdrawValidatorCommission(t *testing.T) {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("satoshi", sdk.NewDec(3).Quo(sdk.NewDec(2))),
	}
	...
	require.Equal(t, sdk.Coins{
		sdk.NewCoin("satoshi", sdk.TokensFromTendermintPower(1000)),
	}, balance)
	...
	require.Equal(t, sdk.Coins{
		...
		sdk.NewCoin("satoshi", expTokens.AddRaw(1)),
	}, balance)
	...
	require.Equal(t, sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("satoshi", sdk.NewDec(1).Quo(sdk.NewDec(2))),
	}, remainder)
